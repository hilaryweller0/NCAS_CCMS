...
What are the Butcher tableau of these schemes?
\begin{enumerate}
\item %
\begin{tabular}{>{\raggedright}p{0.29\textwidth}>{\centering}p{0.29\textwidth}>{\raggedleft}p{0.29\textwidth}}
